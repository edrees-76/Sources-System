...
|---|---|---|
| كحلي داكن (Primary) | `#0B1320` | الخلفيات الرئيسية، الشريط الجانبي |
| ذهبي معدني (Gold) | `#D4AF37` | العناصر التفاعلية، النصوص المميزة |
| تركواز/سيان إشعاعي (Gem Blue) | `#7FC3E8` | لون ثالث مميز — شارات، رسوم بيانية |
