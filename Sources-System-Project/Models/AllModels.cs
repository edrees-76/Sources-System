...
public class NeutronSourceType
{
    ...
    /// <summary>
    /// معامل تحويل التدفق إلى المكافئ المحيطي للجرعة h*_Φ(10) بوحدة pSv·cm².
...
public class NeutronSource
{
    ...
    /// <summary>النشاط الإشعاعي (لنويدة المصدر الأم — Am-241 أو Pu-238 أو Cf-252 إلخ حسب
    /// NeutronSourceType.ParentNuclide) في المصدر كما في شهادته — قيمة مستقلة لا تُشتق من
    /// معدل الانبعاث المُعاير. ISO 8529-1:2021 §4.4: العلاقة بينهما تتأثر بعملية التصنيع
    /// ودرجة الخلط ولا تخضع لصيغة عامة. تاريخ المرجع لاضمحلالها هو CalibrationDate نفسه
    /// (بقرار معتمد، لا حقل تاريخ جديد).</summary>
