...
**حالة المستودع:** الجولة 124 محلياً (ب4 — تقسيم صف بيانات البذر الملتبس "Am-241/Be" إلى "Am-241/Be-Small"/"Am-241/Be-Large" بقيم دقيقة من ISO 8529-1:2021 Table 1 وISO 8529-3:2023 Table 2، مع إبطال الصف القديم بالحذف الناعم) · 1094 اختباراً محلياً (Debug) / 1092 محلياً (Release) · 5 تحذيرات بناء (CS8604) و0 أخطاء
...
مطلوب (`IsDeleted` موجود مسبقاً). **يتبقى لإغلاق ب4 بالكامل:** شاشات الواجهة (النشاط الإشعاعي للمصدر
النيتروني وتاريخ قياسه، شاشة الأنواع المرجعية المستقلة، قسم المراجع العلمية) — جولات لاحقة.
