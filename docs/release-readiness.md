...
النتائج: 46 حالة اختبار جديدة، صفر تراجع مقابل `main`؛ عدّ CI النهائي في PR. **مطلوب قبل الدمج:** تحقق بصري من إدريس لزر تغيير كلمة المرور وحواره وإخفاء زر الاستعادة لغير المدير.
