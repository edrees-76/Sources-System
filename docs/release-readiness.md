...
مطلوبات من الخطة، محدَّثة بعد قرارات إدريس: **مصدر حقيقة واحد للإصدار ونافذة About — منجزان (الجولة 172)**. متبقٍ: منع تشغيل نسختين، `build-release.ps1` موحَّد. **أُلغيت نهائياً (الجولة 174): Silent install، توثيق Exit codes، بصمات SHA-256 للمخرجات — انظر §4.**
