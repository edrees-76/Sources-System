...
تمر دون أي تغيير في التوقعات بعد كل دفعة تعديل) قيد المراجعة (Draft PR، فرع
`refactor/round-201-status-logic-borrow-role`). تفاصيل كاملة في
...
- ~~تبعثر سلاسل الحالة في 45+ موضعاً بلا `enum`، واسم الدور «مدير النظام» مكتوب حرفياً في مواضع
  ...
  (Group A، الجولة 201) تمر دون أي تغيير في التوقعات على القاعدة غير المعدَّلة وبعد كل دفعة تعديل
  (B/C/D)؛ +38 اختبار جديد (Group E) لتغطية الكتالوج الجديد والدور. التفاصيل الكاملة والقرارات في
