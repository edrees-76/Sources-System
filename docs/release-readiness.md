...
**حالة المستودع:** الجولة 125 محلياً (ب4 — أول جولة واجهة: وصل حقول Manufacturer/Model/CapsuleLengthMm/CapsuleDiameterMm على نموذج المصدر النيتروني، وحقل PhotonToNeutronDoseRatio على شاشة الأنواع المرجعية، بحقول الإدخال المخطَّطة في الجولة 123) · 1109 اختباراً محلياً (Debug) / 1107 محلياً (Release) · 5 تحذيرات بناء (CS8604) و0 أخطاء
...
**يتبقى لإغلاق ب4 بالكامل:** النشاط الإشعاعي للمصدر النيتروني وتاريخ قياسه (الحقل مؤجَّل بقرار — انظر
§4)، شاشة الأنواع المرجعية المستقلة الكاملة على نمط مكتبة النظائر (الحالية جزء من نافذة موجودة لا
