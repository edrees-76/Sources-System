...
**حالة المستودع:** `50fb3fd` مدفوع · CI `#94` أخضر · 1057 اختباراً محلياً / 1055 في CI · 5 تحذيرات بناء · 0 أخطاء
...
فُرزت عشرة تعليقات مفتوحة. بعد الإصلاحات: 1063 اختباراً أخضر.
...
### مؤجَّل بعد الإصدار (3) — دَين اختبارات، لا يمسّ سلوك المنتَج

| # | الملف | المسألة | ملاحظة |
|---|-------|---------|--------|
| 6 | Sources.Tests/ClipboardFeedbackTests.cs | مقارنة نصوص عربية حرفية — هشاشة اختبار | لا تمسّ المنتَج المُصدَّر |
| 8 | Services/SystemSettingsService.cs | خطأ بمقدار واحد في طول التحذير (51 بدل 50) | تجميلي؛ اربطه بـ#9 حين يُلمس |
| 9 | Sources.Tests/BackupScanAndSettingsIntegrityTests.cs | توكيد يفحص عدم الاستثناء لا حقيقة الاقتطاع | يُشدَّد مع #8 في مرور واحد |
