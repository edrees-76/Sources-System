...
**حالة المستودع:** الجولة 128 محلياً (ب4 — وصل واجهة النشاط الإشعاعي للمصدر النيتروني (قيمة+وحدة) وعرض النشاط الحالي المحسوب، عُمِّمت عن اسم الأمريسيوم-241 المُقيَّد بتصحيح إدريس قبل الدمج؛ **ب4 مكتملة وظيفياً (123–128)**) · 1133 اختباراً محلياً (Debug) / 1131 محلياً (Release) · 5 تحذيرات بناء (CS8604، مسبقة بلا علاقة بهذه الجولة) و0 أخطاء
