...
**حالة المستودع:** آخر جولة مدموجة على `main` هي الجولة 170 (commit
`066415f`، PR #65). قبلها اندمجت على `main` الجولة 169 (استبدال رقم
التفعيل التجريبي برقم إنتاجي حقيقي، commit `9e207cb`، PR #64) والجولة 168
(إصلاح ازدواجية حوار فرض تغيير كلمة المرور، commit `0481ad3`، PR #63) —
الجولات 168 و169 و170 الثلاث **مدموجة فعلاً**، وليست قيد المراجعة.
