...
[Messages]
; الجولة 210: إصلاح ظهور الأرقام بالهندية (١,١,٠) في شريط العنوان وصفحات المعالج.
...
; تصحيحات إملائية لملف Arabic.isl الرسمي (الجولة 211)، مع بقاء باقي النص حرفياً:
; «بتثبي» ← «بتثبيت»، وهمزات الوصل: «إكتمل/إضغط/الإختصارات/الإنتظار» ← «اكتمل/اضغط/الاختصارات/الانتظار».
